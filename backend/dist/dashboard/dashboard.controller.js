...
let DashboardController = class DashboardController {
    ...
    async getDashboard(req, tankId, startDate, endDate) {
        const filters = {
            tankId,
            dateRange: {
        ...
        return response_util_1.ResponseUtil.success(dashboardData, 'Datos del dashboard obtenidos exitosamente');
    }
};
...
__decorate([
    ...
    __param(1, (0, common_1.Query)('tankId')),
