 ...
 * Versión final con corrección definitiva para la advertencia de Next/Image.
         ...
         <div className="relative min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-4 transition-colors duration-500">
             ...
             <main className="w-full max-w-md animate-in fade-in slide-in-from-bottom-5 duration-500">
                 <header className="text-center mb-6">
                     {/* ===== SOLUCIÓN DEFINITIVA A LA ADVERTENCIA DE IMAGEN ===== */}
                     <Image
                         src="/logo-sena.png"
                         ...
                         style={{ height: 'auto' }} // Este estilo en línea resuelve el conflicto.
                         priority
                     />
